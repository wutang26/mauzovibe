...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <>
            <Head title="Ingia kwenye Akaunti | MauzoVibe" />

            <AuthLayout
                    >
                    
                     {/* title="Karibu Tena 👋"
                subtitle="Ingia kwenye akaunti yako na endelea kusimamia biashara yako kwa MauzoVibe."
        */}
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl shadow-slate-900/10 border border-slate-100 p-6 sm:p-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="mt-2 text-sm text-slate-500 max-w-md mx-auto">
                               Uendelea kusimamia biashara yako kwa MauzoVibe.
                            </p>
                                        ...
                                        {showPassword ? (
                                            ...
                                            >
                                                ...
                                                <path
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    d="M9.88 4.24A9.77 9.77 0 0112 4c5 0 8.5 4 9.5 8a11.6 11.6 0 01-3.11 5.13"
                                                />

                                                <path
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    d="M6.23 6.23C4.44 7.57 3.25 9.46 2.5 12c1 4 4.5 8 9.5 8a9.77 9.77 0 004.12-.88"
                                                />
                                            </svg>
                                        ) : (
                                            <svg
